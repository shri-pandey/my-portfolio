...
export const projectsData = [
    ...
    },
    {
        ...
        projectDesc: 'Real estate is property in the form of land, houses or other buildings. Title insurance guarantees the purchaser of real estate against loss from undiscovered defects in the title to property that has been purchased. Personal property is property other than real estate, or property that is movable or separable from it.',
        tags: ['HTML', 'CSS','Javascript','React', 'Material UI', 'Express', "MongoDB","NodeJS"],
        code: 'https://github.com/Abhijit-singh04/Real_estate',
        demo: '',
